...
int main(){
    ...
    sf::Font Pix;
    Pix.loadFromFile("Images//Pixel_font.ttf");

    // Chargement de l'image de fond
    sf::Texture backgroundTexture1;
    backgroundTexture1.loadFromFile("Images//podium.png");
    ...
    std::list<std::string> wav = {"Images//guitare//guit1.wav","Images//guitare//guit2.wav","Images//guitare//guit3.wav","Images//Images//guitare//guit4.wav"};
    std::list<std::string> png = {"Images//guitare//R1.png","Images//guitare//R2.png","Images//guitare//R3.png","Images//guitare//Stance.png"};
    guitarist.setParameters(wav,png);

    // Déclaration du violoniste et chargement des sons et png
    Violon violonist;
    std::list<std::string> wav1 = {"Images//violon//violon1.wav","Images//violon//violon2.wav","Images//violon//violon3.wav","Images//violon//violon4.wav"};
    std::list<std::string> png1 = {"Images//violon//violon1.png","Images//violon//violon2.png","Images//violon//violon3.png","Images//violon//Stance.png"};
    violonist.setParameters(wav1,png1);

    // Déclaration du batteur et chargement des sons et png
    Tambour drummer;
    std::list<std::string> wav2 = {"Images//batterie//batt1.wav","Images//batterie//batt2.wav","Images//batterie//batt3.wav","Images//batterie//batt4.wav"};
    std::list<std::string> png2 = {"Images//batterie//BL1.png","Images//batterie//BL2.png","Images//batterie//BR1.png","Images//batterie//BR2.png","Images//batterie//Stance.png"};
    drummer.setParameters(wav2,png2);
    
    //Déclaration de l'ocarina et chargement des sons et png
    Ocarina ocarina;
    std::list<std::string> wav3 = {"Images//ocarina//oca1.wav","Images//ocarina//oca2.wav","Images//ocarina//oca3.wav","Images//ocarina//oca4.wav"};
    std::list<std::string> png3 = {"Images//ocarina//oca1.png","Images//ocarina//oca2.png","Images//ocarina//oca3.png","Images//ocarina//Stance.png"};
    ocarina.setParameters(wav3,png3);

    // Déclaration du chef d'orchestre et chargement des sons et png
    Chef_Orchecstre chef;
    std::vector<std::string> png4 = {"Images//chef//chef1.png","Images//chef//chef2.png","Images//chef//chef3.png","Images//chef//chef4.png","Images//chef//Stance.png"};
